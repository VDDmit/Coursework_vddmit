...
alter table task
    add constraint fk_task_assigned_user foreign key (assigned_user_id) references app_user (id);
alter table team_achievement
    add constraint fk_team_achievement_team foreign key (team_id) references team (id);
alter table user_achievement
    add constraint fk_user_achievement_user foreign key (user_id) references app_user (id);
alter table user_project
    add constraint fk_user_project_user foreign key (user_id) references app_user (id);
alter table user_project
...
alter table user_profile
    add constraint fk_user_profile_user foreign key (user_id) references app_user (id);
